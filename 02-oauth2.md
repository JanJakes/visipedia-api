...
2. **Authorization response**
   ...
   | state    | string | The state passed in the client authorization request. If state is not identical to the previously passed one, the whole process should be aborted. |
