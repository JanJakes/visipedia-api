...
2. **Authorization response**
   ...
   | state    | string | The state passed in the client authorization request. If state is not identical to that one passed in the authorization request the whole process should be aborted. |
